...
instance_keys = ["144nodes", "weighted"]
selected_instances = []
folder = "heavy_hex"
short_name_base = "N144HH73"
...
short_name = "009N144HH73"
with open(f"data/hardware/{folder}/{short_name}_d5patgm5v3os73f1p1pg.json", "r") as fin:
...
m_cuts = {}
path = Path("data/minmax_cuts/heavy_hex")
...
markers = {"I_MPS": "s", "I_PP": "X", "F_PP": "D", "F_MPS": ">", "PT_PP_AAA": "o", "FA_PP_opt": "v", "FA_MPS_opt": "^", "TQA_PP_opt": "<",  "TQA_MPS_opt": "1"}
colors = plt.cm.Set1.colors
colors = {"I_MPS": colors[0], "I_PP": colors[1], "F_PP": colors[2], "F_MPS": colors[3], "PT_PP_AAA": colors[4], "FA_PP_opt": colors[5], "FA_MPS_opt": colors[6], "TQA_PP_opt": colors[7],  "TQA_MPS_opt": colors[8]}
nice_labels = {
    ...
    "PT_PP_AAA": "PT with PP, AAA, and MDM"
}
...
plot_args = {
    key: {"color": colors[key]} for key in ["I_MPS", "F_MPS", "I_PP", "F_PP", "PT_PP_AAA", "FA_PP_opt", "FA_MPS_opt", "TQA_PP_opt",  "TQA_MPS_opt"]
}
ax.legend(
    loc="center left",
...
ax.set_title(f"{short_name_base} depth 5")

fig.savefig(f"figures/20260112_d5patgm5v3os73f1p1pg_{short_name_base}.pdf", bbox_inches="tight")